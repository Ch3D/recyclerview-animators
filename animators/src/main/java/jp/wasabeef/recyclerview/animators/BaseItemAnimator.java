...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
	...
	private Comparator<MoveInfo> mMovesComparator = new Comparator<MoveInfo>() {
		@Override
		public int compare(final MoveInfo lhs, final MoveInfo rhs) {
			return lhs.holder.getPosition() > rhs.holder.getPosition() ? 1 : -1;
		}
	};

	private Comparator<ViewHolder> mAdditionsComparator = new Comparator<ViewHolder>() {
		@Override
		public int compare(final ViewHolder lhs, final ViewHolder rhs) {
	...
	public void runPendingAnimations() {
		...
		if(movesPending) {
			...
			mPendingMoves.clear();
			Collections.sort(moves, mMovesComparator);
		...
		if(additionsPending) {
			...
			Collections.sort(additions, mAdditionsComparator);
